...
#include "app_lab_7_1/app_lab_7_1.h"
#include "app_lab_7_2/app_lab_7_2.h"
...
#define USE_APP_LAB_7_1 71
#define USE_APP_LAB_7_2 72

#define APP_USED USE_APP_LAB_7_2
...
void setup() {
    ...
    app_lab_6_2_setup();
  #elif APP_USED == USE_APP_LAB_7_1
    app_lab_7_1_setup();
  #elif APP_USED == USE_APP_LAB_7_2
    app_lab_7_2_setup();
  #endif
}
