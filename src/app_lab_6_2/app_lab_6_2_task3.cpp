...
void app_lab_6_2_task3(void *pvParameters) {
    ...
    for (;;) {
        ...
        // Row 0: T:XX.XC SP:XX.X
        // Row 1: A:ON O:XXX% !ALT   (A=AUTO, M=MANUAL)
        const char *mode_char  = (snap.mode == CTRL_MODE_AUTO) ? "A" : "M";
        ...
        snprintf(r1, 17, "%s:%3s O:%3d%%%4s", mode_char, relay_str, snap.pid_output, alert_str);
